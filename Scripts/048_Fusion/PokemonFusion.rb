...
class PokemonFusionScene
  ...
  def pbFusionScreen(cancancel = false, superSplicer = false, firstOptionSelected = false)
    ...
    if canceled
      ...
      pbChooseAbility(@pokemon1, hiddenAbility1, hiddenAbility2, custom1, custom2)
...
def pbChooseAbility(poke, hidden1 = false, hidden2 = false, custom1 = nil, custom2 = nil)
  ...
  abID1 = custom1 ? custom1 : (hidden1 ? abilityList[4][0] : abilityList[0][0])
  abID2 = custom2 ? custom2 : (hidden2 ? abilityList[5][0] : abilityList[1][0])
